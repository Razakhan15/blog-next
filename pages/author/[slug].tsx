      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          ...
          <div className="p-10 text-gray-500 sm:text-lg dark:text-gray-400">
            ...
            <Image priority={true} width={144} height={144} className="w-36 h-36 p-2 rounded-full mx-auto ring-2 ring-gray-300 dark:ring-gray-500" src="https://flowbite.com/docs/images/people/profile-picture-2.jpg" alt="Bordered avatar" />

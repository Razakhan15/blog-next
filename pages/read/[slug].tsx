        ...
        <div className="flex flex-col justify-between px-4 mx-auto max-w-screen-xl">
          <article className="mx-auto w-full max-w-3xl prose lg:prose-xl prose-stone dark:prose-invert">
            <div className="my-4 flex items-center justify-between">
              ...
              <Link
                className="text-xl mb-6 no-underline"
                href={`/tags/${singlePost.tags[0]
                  .trim()
                  .toLowerCase()
                  .replaceAll(" ", "-")}`}
              >
            ...
            <p className="lead">{singlePost.description}</p>
            ...
            <header className="mb-4 lg:mb-6 not-format">
              <address className="flex items-center mb-6 not-italic">
                <div className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                  ...
                  <time
                    className="text-base font-light text-gray-500 dark:text-gray-400 mx-1"
